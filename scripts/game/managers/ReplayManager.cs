...
public partial class ReplayManager : Node
{
	...
	public static TextureButton speedUp;
	public static TextureButton speedDown;
	...
	public override void _Ready()
	{
		...
		speedUp = ReplayViewer.GetNode<TextureButton>("SpeedUp");
		speedDown = ReplayViewer.GetNode<TextureButton>("SpeedDown");
	...
	public void SpeedUp()
	{
		SoundManager.Song.PitchScale = SoundManager.Song.PitchScale + (float)0.5;
		GD.Print(SoundManager.Song.PitchScale);
	}
