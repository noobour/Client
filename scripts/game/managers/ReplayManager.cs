...
public partial class ReplayManager : Node
{
	...
	private static CpuParticles3D cursorPath;
	...
	public override void _Ready()
	{
		...
		cursorPath ??= Runner.Cursor.GetNode<CpuParticles3D>("CursorPath");
	...
	public void ShowCursorPath(Attempt attempt, bool? show = null)
	{
		Enabled = show ?? !Enabled;
		bool visible = Enabled && attempt.IsReplay;
		
		cursorPath.Emitting = visible && attempt.IsReplay;
	}
